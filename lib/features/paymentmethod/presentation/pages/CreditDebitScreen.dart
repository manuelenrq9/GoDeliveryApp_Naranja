                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      // Mostrar aviso de procesamiento del pago
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          ...
                          backgroundColor:
                              Color.fromARGB(255, 27, 243, 7), // Color naranja
                          duration: Duration(seconds: 3), // Duración del aviso
                        ),
                      );

                      // Aquí se podría simular un procesamiento con un Future.delayed:
                      Future.delayed(const Duration(seconds: 3), () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            ...
                            backgroundColor:
                                Color.fromARGB(255, 34, 243, 6), // Color verde
                          ),
                        );
                      });
                    }
